    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <motion.div 
              variants={fadeIn}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-slate-200 text-xs font-medium mb-8 backdrop-blur-md"
            >
              <span className="flex h-2 w-2 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
              </span>
              <span className="text-emerald-600 uppercase tracking-widest font-bold">New:</span> 
            ...
            >
              <Link
                href="/register"
                className="group relative px-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-slate-900 text-lg font-bold rounded-2xl flex items-center gap-3 transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] overflow-hidden"
              >
              ...
              <button className="px-8 py-4 bg-white hover:bg-slate-100 border border-slate-200 text-slate-900 text-lg font-bold rounded-2xl transition-all backdrop-blur-md">
                Watch Product Demo
              </button>
            </motion.div>
            ...
            <motion.div 
              variants={fadeIn}
              className="mt-12 flex items-center justify-center gap-4 text-sm text-slate-600 font-medium"
            >
              <div className="flex -space-x-3">
                ...
                <div className="w-10 h-10 rounded-full border-2 border-[#05060f] bg-emerald-600 flex items-center justify-center text-[10px] font-bold text-slate-900">1k+</div>
              </div>
              <p>Trusted by <span className="text-slate-900 font-bold">1,200+</span> B2B Sales Teams & Agencies</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-[#0d0e1a] rounded-[32px] border border-slate-200 shadow-2xl overflow-hidden aspect-[16/9]">
               ...
               <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                  ...
                  <h3 className="text-2xl font-bold mt-6 text-slate-900">Seeing is Believing.</h3>
                  <p className="text-slate-600 mt-2">Take a look at the AI-powered lead engine in action.</p>
               </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                key={i}
                whileHover={{ y: -10 }}
                className="p-8 rounded-3xl bg-white/[0.03] border border-slate-200 hover:border-white/20 transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-slate-50 p-8 rounded-[40px] border border-slate-200 shadow-3xl">
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-emerald-500 text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-600">Everything you need to find and close leads in one dashboard. No more switching between 5 different tools.</p>
            </div>
            <div className="flex bg-white p-1 rounded-xl border border-slate-200 backdrop-blur-md">
              <button 
                onClick={() => setActiveTab('b2b')}
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'b2b' ? 'bg-emerald-600 text-slate-900 shadow-lg' : 'text-slate-600 hover:text-slate-900'}`}
              >
                B2B Lead Search
              </button>
              <button 
                onClick={() => setActiveTab('people')}
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'people' ? 'bg-emerald-600 text-slate-900 shadow-lg' : 'text-slate-600 hover:text-slate-900'}`}
              >
                People Intelligence
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-stretch">
            <div className="lg:col-span-4 space-y-4">
              {[
                ...
                <div key={i} className="p-6 rounded-2xl bg-white border border-slate-100 hover:bg-slate-50 transition-all cursor-pointer group">
            ...
            <div className="lg:col-span-8 relative">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/20 to-emerald-700/20 blur-[100px] opacity-30" />
              <div className="h-full bg-white/[0.03] border border-slate-200 rounded-[32px] p-8 relative z-10 overflow-hidden group">
                    ...
                    >
                      <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="hidden sm:flex gap-2">
                           <span className="px-3 py-1 bg-white rounded-full text-[10px] font-bold text-slate-600 border border-slate-200 italic">#Retail</span>
                           <span className="px-3 py-1 bg-white rounded-full text-[10px] font-bold text-slate-600 border border-slate-200 italic">#Healthcare</span>
                           <span className="px-3 py-1 bg-white rounded-full text-[10px] font-bold text-slate-600 border border-slate-200 italic">#RealEstate</span>
                        </div>
                      </div>
                      <div className="flex-1 rounded-2xl bg-black/40 border border-slate-100 p-6 overflow-hidden relative">
                         <div className="flex items-center gap-4 mb-6 border-b border-slate-100 pb-4">
                            <Search className="text-emerald-500 w-5 h-5" />
                            <div className="text-sm text-slate-600 font-mono">Searching for <span className="text-slate-900">&quot;Software Companies in Bangalore&quot;</span>...</div>
                         </div>
                         <div className="space-y-4">
                            {[1, 2, 3].map(i => (
                              <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-white border border-slate-100 animate-pulse">
                                 <div className="flex items-center gap-3">
                    ...
                    >
                      ...
                      <div className="flex-1 rounded-2xl bg-black/40 border border-slate-100 p-6 overflow-hidden relative">
                         <div className="flex items-center gap-4 mb-6">
                            ...
                            <div className="text-sm text-slate-600">Filtering Decision Makers...</div>
                         </div>
      ...
      <section className="py-24 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-[10%] right-[10%] h-[2px] bg-white -z-10" />
            ...
            {[
              ...
              <div key={i} className="relative group text-center md:text-left">
                <div className="text-7xl font-black text-slate-900/5 absolute -top-8 -left-4 pointer-events-none group-hover:text-emerald-500/10 transition-colors">{s.step}</div>
                <div className="mb-6 inline-flex p-4 rounded-3xl bg-white border border-slate-200 group-hover:scale-110 transition-transform">{s.icon}</div>
      ...
      <section className="py-32 relative overflow-hidden" id="pricing">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 text-lg">Choose a plan that fits your growth stage. No hidden fees. <span className="text-slate-900 font-bold underline decoration-emerald-500">GST Invoice included.</span></p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
            {plans.length > 0 ? plans.map((plan, i) => (
              ...
              >
                {i === 1 && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-indigo-600 text-slate-900 text-[10px] font-black tracking-widest px-4 py-1 rounded-full">MOST POPULAR</div>
                )}
                ...
                <div className={`p-4 rounded-2xl mb-8 font-bold text-center border ${
                  i === 1 ? 'bg-indigo-500/10 border-indigo-500/30 text-indigo-600' : 'bg-white border-slate-200 text-slate-600'
                }`}>
                ...
                <Link 
                  ...
                  className={`w-full py-4 rounded-2xl font-black text-center transition-all ${
                    i === 1 ? 'bg-emerald-600 hover:bg-emerald-500 shadow-lg' : 'bg-white hover:bg-slate-100 border border-slate-200'
                  }`}
                >
                  Get Started Now
                </Link>
              ...
              [1,2,3].map(i => (
                <div key={i} className="p-8 rounded-[32px] border border-slate-200 bg-white animate-pulse h-[500px]" />
              ))
            )}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6">
           ...
           <div className="space-y-4">
              {[
                ...
                <details key={i} className="group p-6 rounded-2xl bg-white border border-slate-100 hover:bg-slate-50 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
           ...
           <div className="grid grid-cols-2 gap-4 shrink-0">
              <div className="p-6 rounded-2xl bg-white border border-slate-200 text-center">
                 <div className="text-2xl font-black text-slate-900">256-bit</div>
      ...
      <section className="py-32 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
           ...
           >
              <h2 className="text-4xl md:text-7xl font-black text-slate-900 mb-8 italic">Taiyar ho? <br />Apna Dhanda Badhao.</h2>
