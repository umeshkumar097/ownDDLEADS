    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-emerald-500/20">
      ...
      <header className="relative pt-24 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          {/* Static H1 for SEO bots — visually hidden but readable by crawlers */}
          <h1 className="sr-only">India&apos;s #1 B2B Lead Generation Platform — DhandaLeads by Aiclex Technologies</h1>
          <DynamicHeroText />
          ...
          <div className="flex items-center justify-center gap-2 text-sm font-bold text-slate-500 mb-16">
            <div className="flex -space-x-2 relative z-10">
              <Image src="https://randomuser.me/api/portraits/men/44.jpg" width={32} height={32} alt="Indian entrepreneur using DhandaLeads" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
              <Image src="https://randomuser.me/api/portraits/women/60.jpg" width={32} height={32} alt="B2B sales professional" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
              <Image src="https://randomuser.me/api/portraits/men/71.jpg" width={32} height={32} alt="Agency owner using DhandaLeads" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
              <Image src="https://randomuser.me/api/portraits/women/72.jpg" width={32} height={32} alt="Sales manager India" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center shrink-0"><Bot className="w-6 h-6 text-emerald-400" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center shrink-0"><LayoutDashboard className="w-6 h-6 text-emerald-400" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center shrink-0"><RefreshCcw className="w-6 h-6 text-emerald-400" /></div>
                  <div>
                ...
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center shrink-0"><MessageSquare className="w-6 h-6 text-emerald-400" /></div>
                  <div>
                  ...
                  <div className="bg-white/5 p-4 rounded-xl flex justify-between items-center border border-indigo-500/30">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-slate-400 text-xs mt-1 leading-relaxed">&quot;Hi Rahul, noticed TechCorp&apos;s recent expansion in Mumbai...&quot;</div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              <h4 className="font-bold text-lg text-slate-900 flex items-center gap-2"><Star className="w-5 h-5 text-amber-500" /> Are these leads from real businesses?</h4>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600 mt-2">Yes, simply enter your company details and GSTIN during the checkout process to receive an automatic B2B tax invoice.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-emerald-700 relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8">Apna Dhanda Badhao, Aaj Hi Shuru Karo.</h2>
          <button
